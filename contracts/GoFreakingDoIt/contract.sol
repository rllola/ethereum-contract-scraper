...
contract GoFreakingDoIt is Ownable {
	...
	// app.setGoal("Finish cleaning", "[email protected]", "[email protected]", "2017-12-12", {value: web3.toWei(11.111, 'ether')})
	// app.setGoal("Finish cleaning", "[email protected]", "[email protected]", "2017-12-12", {value: web3.toWei(11.111, 'ether'), from: web3.eth.accounts[1]})
